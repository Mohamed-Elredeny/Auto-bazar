    ...
    <div class="navbar-light m-2 " style="overflow-x: hidden;">
        <div class="row">
            <div class="col-5 text-left">
                <a class="logo ml-2" href="{{route('home')}}" style="color: #17286E;margin-top:5px;font-size:21px;font-family:'Bauhaus 93' !important;">&#160;&#160;Auto Bazaar </a>
            </div>
            <div class="col-6 text-right font_mob" >
            @desktop
            <a style="color:#17286E;font-size:14px;" href="{{LaravelLocalization::getLocalizedURL('ar') }}">@if(app()->getLocale() == 'ar') <span style="color:#204bfa">العربية</span> @else العربية @endif</a>  | <a style="color:#17286E;font-size:14px;" href="{{LaravelLocalization::getLocalizedURL('en') }}">@if(app()->getLocale() == 'en') <span style="color:#204bfa">English</span> @else English @endif</a> | <a style="color:#17286E;font-size:13px;" href="{{LaravelLocalization::getLocalizedURL('ku') }}">@if(app()->getLocale() == 'ku') <span style="color:#204bfa">كوردى</span> @else كوردى @endif</a>
            @elsedesktop
            <a style="color:#17286E;font-size:13px;" href="{{LaravelLocalization::getLocalizedURL('ar') }}">@if(app()->getLocale() == 'ar') <span style="color:#204bfa">العربية</span> @else العربية @endif</a>  | <a style="color:#17286E;font-size:14px;" href="{{LaravelLocalization::getLocalizedURL('en') }}">@if(app()->getLocale() == 'en') <span style="color:#204bfa">English</span> @else English @endif</a> | <a style="color:#17286E;font-size:13px;" href="{{LaravelLocalization::getLocalizedURL('ku') }}">@if(app()->getLocale() == 'ku') <span style="color:#204bfa">كوردى</span> @else كوردى @endif</a>
...
<nav class="navbar navbar-expand-lg navbar-light color_site_bg" id="navToty" dir="rtl" style="padding: 0px !important; justify-content:space-around">
    @else
...
@else
    ...
    <div class="navbar-light m-2 " style="overflow-x: hidden;">
     ...
     @if(LaravelLocalization::getCurrentLocale() != 'en')
    <nav class="navbar navbar-expand-lg navbar-light color_site_bg" id="navToty" dir="rtl" style="padding: 0px !important; justify-content:space-around;direction:rtl;text-align:right;">
    @else
