                                ...
                                <div class="carousel-item active " style="">
                                    <div class="carousel-container">
                                        <div class="container">
                                            ...
                                            <div class="form-group row " style="height:700px">
                                                <div class="col-sm-12">
                                                    {{--
                                    ...
                                    <div class="item carousel-item active  team ">
                                        <div class="row ">
                                            @for($j=0;$j< count($sellTypes);$j++)
                                                <div class="col-6  col-lg-2 " onMouseOver="myfuncMouseOver({{$sellTypes[$j]['id']}},'{{$sellTypes[$j]['image']}}')" onMouseOut="myfuncMouseOut({{$sellTypes[$j]['id']}},'{{$sellTypes[$j]['image']}}')" >
                                                    <div class="member color_site_card " data-aos="fade-up" data-aos-delay="100" @desktop style="height:170px;cursor:pointer;border:1px solid blue"   @elsedesktop style="height:140px;cursor:pointer;border:1px solid blue"  @enddesktop >
                                                        <a href="{{route('type.subcategory',['type_category'=>$sellTypes[$j]['id'] ] )}}" @desktop  @elsedesktop style="text-decoration:none;width:70%;display:inline-block;margin-right:3px" @enddesktop>
                                                            ...
                                                            <div class="member-info color_site_card_member_font">
                                                                <h4 style="margin:-12px;" id="textmyfuncMouseOver{{$sellTypes[$j]['id']}}">{{$sellTypes[$j]['Title_'. App::getlocale()]}}</h4>
                                                            </div>
                                                        </a>
            ...
            <section id="team" class="team section-bg">
                <div class="container">
                    ...
                    @foreach($specialization as $spec)
                            <div class="col-6  col-lg-2" onMouseOver="myfuncMouseOver({{$spec['id']}},'{{$spec['image']}}')" onMouseOut="myfuncMouseOut({{$spec['id']}},'{{$spec['image']}}')"  >
                            <a onMouseOver="myfuncMouseOver({{$spec['id']}},'{{$spec['image']}}')" id="new" onMouseOut="myfuncMouseOut({{$spec['id']}},'{{$spec['image']}}')" class="" href="{{route('type.ProfileWithCat',['type'=>$spec->id])}}" @desktop  @elsedesktop  @enddesktop>
                                <div class="member color_site_card p3" data-aos="fade-up" data-aos-delay="100" @desktop style="height:170px;cursor:pointer;border:1px solid blue"   @elsedesktop style="height:158px;cursor:pointer;right:70;border:1px solid blue"  @enddesktop >
                                    <div>
                                        <div class="member-img">
                                            <img id="moka_cars_{{$spec['id']}}" src="{{asset('assets/images/icons/blue/'.$spec['image'])}}" class="img-fluid" alt="" style="height:77px;width:100%;">
                                        </div>
                                        <h4 id="textmyfuncMouseOver{{$spec->id}}" class="mt-3">{{$spec['Title_'. App::getlocale()]}}</h4>
                                    </div>
                                </div>
                        ...
                        @foreach($autoShops as $shop)
                            <div class="col-lg-3 col-12" style='cursor:pointer;'>
                                <a  href="{{route('profile-index',['type'=>'maintenance','id'=>$shop->id])}}">
                                    <div class="member" data-aos="fade-up" data-aos-delay="100" style="padding:0px;">
                                        <div class="member-img" >
