...
@section('content')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="  mb-3 justify-content-around d-flex" style="font-size:13px">
                                <div class="wishBtn m-1 p-1 pr-2 pl-2">
                                    <?php
                                    if(Auth::user()){
                                        $exist = \App\models\UserFavorite::where('user_id',Auth::user()->id)->where('product_id',$product->id)->get();
                                    }else{
                                        $exist = [] ;
                                    }
                                    ?>
                                    @if(count($exist) > 0)
                                        <a href="{{route('wishlist.action',['action'=>'remove','product_id'=>$product->id])}}" class=" text-white text-decoration-none"> <i class="far fa-heart"> </i>
                                           {{__('dina.Add_to_wishlist')}}
                                        </a>
                                    @else
                                        <a href="{{route('wishlist.action',['action'=>'add','product_id'=>$product->id])}}" class=" text-white text-decoration-none"> <i class="far fa-heart"> </i>
                                            Remove  Wishlist
                                        </a>
                                    @endif
                                </div>
                                <div class="wishBtn m-1 p-1 pr-2 pl-2">
                                    <a href="https://wa.me/{{ $product->user->city->code .$product->user->phone1 }}?text=product%20link%20:%20http://127.0.0.1:8000/product/details/{{$product->id}}"
                                       ...
                                       class=" text-white text-decoration-none"> <img
                                            ...
                                            width="20" alt="..."> {{__('dina.Contact_whatsapp')}}</a>
                                ...
                                <div class="wishBtn m-1 p-1 pr-2 pl-2">
                                    <a href="tel:+{{$product->user->phone1}}" target="_blank"
                                       class=" text-white text-decoration-none"> <i class="fa fa-phone"> </i> {{__('dina.Direct_connections')}}</a>
                            ...
                            <div class="row d-flex justify-content-around d-flex align-items-center">
                                ...
                                border-radius:50%;
                                background: #FF9B40;
                                display: inline-block;"></div> {{$product->status['Title_'. App::getlocale()]}}
                                </div>
                                <div>
                                    <i class="fas fa-map-marker-alt smallColor"></i> {{$product->user->city['Title_' . App::getlocale()]}}
                                </div>
                            </div>
                ...
                <div class="col-12 mt-4">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                            <div class="m-4 row">
                                <div class="col-6 col-lg-3 p-2">
                                    <div class="smallColor font-weight-bold">{{__('product.product_status')}}</div>
                                ...
                                @if($product->sellType->id != 5 && $product->sellType->id !=6 && $product->category->id != 4  && $product->category->id != 2 )
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('dina.MileAge')}}</div>
                                        <div>{{$product->distance}} KM</div>
                                    </div>
                                @endif
                                @if($product->sellType->id == 5)
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('product.Section')}}</div>
                                        <div>{{$product->section['Title_'.App::getlocale()]}} </div>
                                    </div>
                                @endif
                                <div class="col-6 col-lg-3 p-2">
                                    <div class="smallColor font-weight-bold">{{__('product.country')}}</div>
                                    <div>{{$product->city->Title_en}}</div>
                                </div>
                                @if($product->sellType->id != 6 && $product->sellType->id != 7 && $product->category_id != 4 && $product->category_id != 2)
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor">{{__('product.interior_brush')}} </div>
                            ...
                            <div class="m-4 row">
                                <div class="col-6 col-lg-3 p-2">
                                    <div class="smallColor font-weight-bold">{{__('product.year')}}</div>
                                    <div>{{$product->year}}</div>
                                </div>
                                @if($product->category->id != 2 && $product->category->id != 4)
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('product.color')}}</div>
                                        <div>
                                            <div style="width: 15px;
                                                height: 15px;
                                                border-radius:50%;
                                ...
                                @endif
                                <div class="col-6 col-lg-3 p-2">
                                    <div class="smallColor font-weight-bold">{{__('product.city')}}</div>
                                ...
                                @if(( $product->sellType->id != 6 && $product->sellType->id != 7 ) && $product->category->id != 2 && $product->category->id != 4)
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('product.interior_color')}}</div>
                                        <div>
                                            <div style="width: 15px;
                                                height: 15px;
                                                border-radius:50%;
                            ...
                            <div class="m-4 row">
                                ...
                                @endif
                                <div class="col-6 col-lg-3 p-2">
                                    <div class="smallColor font-weight-bold">{{__('product.Payment_method')}}</div>
                            ...
                            <div class="m-4 row">
                                @if($product->sellType->id != 6 && $product->category->id != 2)
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('dina.fuel_Type')}}</div>
                                ...
                                @if($product->category->id == 2)
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('dina.Country_of_Origin')}}</div>
                                ...
                                @if( $product->category->id != 4 &&  $product->category->id != 2  && $product->sellType->id != 1 && $product->sellType->id != 3 && $product->sellType->id != 4 && $product->sellType->id != 6 && $product->sellType->id != 7 )
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('product.work_hours')}}</div>
                                ...
                                @if($product->sellType->id != 6 && $product->category->id !=2)
                                    ...
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('dina.Engine_Power')}}</div>
                                        @if(isset($product->engine_capacity))
                                            <div>{{$product->engine_capacity}} {{__('product.Hp')}}</div>
                                        @endif
                                    </div>
                                    <div class="col-6 col-lg-3 p-2">
                                        <div class="smallColor font-weight-bold">{{__('product.slinder_number')}}</div>
                        ...
                        <div class="tab-pane fade" id="seller" role="tabpanel" aria-labelledby="seller-tab">
                            <div class="row w-75 m-auto">
                                ...
                                <div class="mt-4 col-12 col-lg-4 p-2">
                                    <div class="smallColor font-weight-bold">{{__('dina.Company’s_Name')}}</div>
                                    <div>{{$product->user->company_name}}</div>
                                    <br>
                                    <div class="smallColor font-weight-bold">{{__('dina.Shop_type')}}</div>
                                    <div>{{$product->user->MyshopType['Title_'. App::getlocale()] }}</div>
                                </div>

                                <div class="col-12 col-lg-4 p-2">
                                    <div class="mt-4">
                                        <div class="smallColor font-weight-bold">{{__('dina.Social_Media_Links')}}</div>
                                        <div>
                                            <a href="{{$product->user->phone1}}">
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-2 col-md-4 mb-3">
                    <div class="p-4 text-center rounded-circle"
                        ...
                        @if(isset($product->fuelType) && $product->sellType->id != 6)
                            {{$product->fuelType['Title_' . App::getlocale()]}}
                        @else
                            Default
                        @endif
                    </div>
                ...
                <div class="col-6 col-lg-2 col-md-4 mb-3">
                    <div class="p-4 text-center rounded-circle"
                        ...
                        @if(isset($product->GearBox)  && $product->sellType->id != 6)
                            {{$product->GearBox['Title_' . App::getlocale()]}}
                        @else
                            Default
                        @endif
                    </div>
                ...
                <div class="col-6 col-lg-2 col-md-4 mb-3">
                    <div class="p-4 text-center rounded-circle"
                        ...
                        <br> -->
                        <h6 class=""
                            style="vertical-align: middle; display: table-cell; color: #17286E;font-weight: bolder">{{$product->status['Title_' . App::getlocale()]}}</h6>
    ...
    <section id="portfolio" class="portfolio">
        <div class="container">
            ...
            <center>
                <a href="" style="color:#17286E">{{__('dina.Show_moreproducts')}} </a>
            </center>
        </div>
    ...
    <section id="portfolio" class="portfolio">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-up">
                <h2>{{__('dina.RELATED_PRODUCTS')}} </h2>
            </div>
