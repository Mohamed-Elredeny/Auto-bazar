            ...
            <div class="container">
                ...
                <div class="row">
                    @foreach($specialization as $spec)
                        @if($spec->id != $type)
                        <a class="col-sm-3" href="{{route('type.ProfileWithCat',['type'=>$spec->id])}}" style="text-decoration:none;display:inline-block">
                            <div class="col-sm-3 align-items-stretch " onMouseOver="myfuncMouseOver({{$spec->id}})" onMouseOut="myfuncMouseOut({{$spec->id}})"  >
                                <div class="member color_site_card p3" data-aos="fade-up" data-aos-delay="100" style="width: 250px;height:100px;cursor:pointer;"   >
                                    <div>
                            ...
                            <a  href="{{route('profile-index',['type'=>'maintenance','id'=>$shop->id])}}">
                                <div class="member" data-aos="fade-up" data-aos-delay="100">
                                    <div class="member-img" style="padding:0">
                                        <img src="{{asset('assets/images/autoShops/'.$shop->cover)}}" class="img-fluid" alt="" style="height:150px;width:200px;padding:0">
                                    </div>
