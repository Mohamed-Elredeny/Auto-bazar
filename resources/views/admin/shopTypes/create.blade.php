    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h5 class="mb-5 mt-3">اضافة نوع متجر جديد</h5>

                <form method="post" action="{{route('admin.shopTypes.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">نوع المتجر باللغة العربية</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">نوع المتجر باللغة الانجليزية</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label">نوع المتجر باللغة الكردية</label>
                        <div class="col-sm-10">
